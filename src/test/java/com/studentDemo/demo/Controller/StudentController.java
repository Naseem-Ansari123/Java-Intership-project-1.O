...
public class StudentController {
    ...
    @PostMapping("/createStudent") // http://localhost:8080/api/createStudent
    ...
    public ResponseEntity<StudentResponseDTO> updateStudent(@RequestParam UUID enrollmentNO, @RequestBody StudentRequestDTO studentRequestDTO) {

        return new ResponseEntity<>(studentService.updateStudent(enrollmentNO,studentRequestDTO),HttpStatus.OK);
    }
